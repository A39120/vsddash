...
data class VRS(
    ...
    @Json(name = "externalID") val externalID: Any? = Any(),
    ...
    @Json(name = "location") val location: Any? = Any(),
    @Json(name = "managementIP") val managementIP: String? = "",
    @Json(name = "messages") val messages: Any? = Any(),
    ...
    @Json(name = "vscConfigState") val vscConfigState: Any? = Any(),
    @Json(name = "vscCurrentState") val vscCurrentState: Any? = Any()
)